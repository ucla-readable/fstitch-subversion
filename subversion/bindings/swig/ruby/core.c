...
SWIGEXPORT void Init_core(void) {
    ...
    rb_define_const(mCore,"SVN_VER_PATCH", INT2NUM(3));
    rb_define_const(mCore,"SVN_VER_MICRO", INT2NUM(3));
    rb_define_const(mCore,"SVN_VER_LIBRARY", INT2NUM(1));
    rb_define_const(mCore,"SVN_VER_TAG", rb_str_new2(" (r23084)"));
    rb_define_const(mCore,"SVN_VER_NUMTAG", rb_str_new2("\0"));
    rb_define_const(mCore,"SVN_VER_REVISION", INT2NUM(23084));
